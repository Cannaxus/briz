...
$form['form-2'] = array(
	'fields' => array(
		'name' => array(
			...
			'messages' => array(
				'minlength' => 'Минимальная длинна поля [ Ваше имя ] меньше допустимой - %2$s',
				'maxlength' => 'Максимальная длинна поля [ Ваше имя ] превышает допустимую - %2$s',
			)
		),
		'tell' => array(
			...
			'messages' => array(
				'minlength' => 'Минимальная длинна поля [ Телефон / e-mail ] меньше допустимой - %2$s',
			)
		),
		'text' => array(
			'title' => 'Сообщение',
		...
		'checkbox' => array(
			'title' => 'Соглашение на обработку<br> персональных данных',
			'validate' => array(
				'minlength' => '1',
			),
			'messages' => array(
				'minlength' => 'Необходимо согласиться на обработку персональных данных',
			)
		),
	),
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Обратная связь МЕГАДОР (Опт)',
		'title' => 'Стать партнером',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'megador@email.com',
		'from_name' => 'megador',
		'to_email' => 'cannaxus@gmail.com',
		...
		'okay' => '<div class="contacts__popup">
                   
                    <div class="contacts__popup--header">
                        <p>Спасибо!</p>
                    </div>
                    <div class="contacts__popup--text-block">
                        <p>Ваше сообщение отправлено! Наши специалисты с вами свяжутся</p>
                        <buttom class="contacts__popup--btn arcticmodal-close">Хорошо</buttom>
                    </div>
                    </div>',
		'fuck' => 'Сообщение неотправлено - ERROR',
		'spam' => 'Cпам робот',
...
$form['form-3'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Обратная связь МЕГАДОР (Розница)',
		'title' => 'Стать партнером',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'megador@email.com',
